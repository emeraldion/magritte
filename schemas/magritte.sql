...
--
-- Host: localhost:8889
-- Generation Time: Aug 06, 2026 at 08:50 AM
...
CREATE TABLE `pipelines` (
  ...
  `quiet_period_ms` int(11) NOT NULL DEFAULT '5000' COMMENT 'Interval in milliseconds a task sits in the queue after being triggered but before actual execution begins.',
  `grace_period_ms` int(11) NOT NULL DEFAULT '5000' COMMENT 'Interval in milliseconds the system allows after operations finish before actual termination.',
